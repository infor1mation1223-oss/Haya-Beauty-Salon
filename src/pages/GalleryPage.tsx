        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <button
                  ...
                  className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                    activeCategory === category
                      ...
                      : 'bg-white text-[var(--color-text-secondary)] hover:bg-[var(--color-surface)] hover:text-[var(--color-primary)] border border-[var(--color-border)]'
                  }`}
                >
                  {category}
                </button>
            ...
            <AnimatePresence mode="popLayout">
              {filteredImages.map((image, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 ring-2 ring-inset ring-white/0 group-hover:ring-[var(--color-accent)]/50 transition-all duration-300 rounded-xl" />
                </motion.div>
              ))}
            </AnimatePresence>
          </motion.div>
          ...
          {filteredImages.length === 0 && (
            <div className="text-center py-20">
              <p className="text-[var(--color-text-muted)]">No images in this category yet.</p>
            </div>
          )}
        </div>
      </section>
            ...
            <div className="text-center">
              ...
              {siteConfig.business.social.instagram && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#f09433] via-[#e6683c] to-[#bc1888] text-white rounded-full font-medium hover:shadow-lg transition-all hover:-translate-y-0.5"
                >
