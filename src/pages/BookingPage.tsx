    ...
    <div className="pt-20">
      ...
      <section className="relative py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl text-white font-medium mb-6">
              Book Your Appointment
            </h1>
            <p className="text-white/80 text-lg lg:text-xl max-w-2xl mx-auto">
              Schedule your beauty session at Haya Beauty Salon
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              <AnimatedSection direction="right">
                <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-lg">
                  <h2 className="font-heading text-2xl font-medium text-[var(--color-text)] mb-2">
                  ...
                  {submitted ? (
                    ...
                    >
                      ...
                      <p className="text-[var(--color-text-secondary)] mb-8 max-w-md mx-auto">
                        Thank you for choosing Haya Beauty Salon. We'll contact you shortly to confirm
                        your appointment at <strong>{formData.date}</strong> at <strong>{formData.time}</strong>.
                      </p>
                      <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a
                          ...
                          className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[var(--color-primary)] text-white rounded-full font-medium"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div>
                          <label htmlFor="date" className="block text-sm font-medium text-[var(--color-text)] mb-2">
                            Preferred Date *
                          </label>
                          <div className="relative">
                        ...
                        <div>
                          <label htmlFor="time" className="block text-sm font-medium text-[var(--color-text)] mb-2">
                            Preferred Time *
                          </label>
                          <div className="relative">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`w-full px-4 py-3 rounded-xl border appearance-none bg-white ${
                            errors.service ? 'border-red-500' : 'border-[var(--color-border)]'
                          } focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20 focus:border-[var(--color-primary)] transition-colors`}
                        >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <MessageSquare className="absolute left-4 top-4 w-5 h-5 text-[var(--color-text-muted)]" />
                          <textarea
                            id="message"
                            name="message"
                            ...
                            onChange={handleChange}
                            rows={3}
                            className="w-full pl-12 pr-4 py-3 rounded-xl border border-[var(--color-border)] resize-none focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20 focus:border-[var(--color-primary)] transition-colors"
                      ...
                      <button
                        ...
                        className="w-full py-4 bg-[var(--color-primary)] text-white rounded-xl font-medium hover:bg-[var(--color-primary-dark)] transition-colors disabled:opacity-70 flex items-center justify-center gap-2 text-lg"
                      >
                        {isSubmitting ? (
                          <>
                      ...
                      <p className="text-[var(--color-text-muted)] text-sm text-center">
                        We'll contact you to confirm your appointment. For immediate booking, call us directly.
                      </p>
                    </form>
                  )}
                </div>
            ...
            <div className="space-y-8">
              <AnimatedSection direction="left" delay={0.1}>
                <div className="bg-[var(--color-primary)] rounded-2xl p-8 text-white">
                  <h3 className="font-heading text-xl font-medium mb-6">Quick Booking</h3>
                  <p className="text-white/80 mb-6">
                    Prefer to book by phone? Call us directly and we'll schedule your appointment.
                  </p>
                  <a
                    href={`tel:${siteConfig.business.phone}`}
                    className="flex items-center justify-center gap-3 w-full py-4 bg-white text-[var(--color-primary)] rounded-xl font-medium hover:bg-white/90 transition-colors"
                  >
              ...
              <AnimatedSection direction="left" delay={0.2}>
                <div className="bg-white rounded-2xl p-8 shadow-sm">
                  <h3 className="font-heading text-xl font-medium text-[var(--color-text)] mb-6">
                    Contact Information
                  </h3>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm text-[var(--color-text-muted)]">Hours</p>
              ...
              <AnimatedSection direction="left" delay={0.3}>
                <div className="bg-[var(--color-surface-alt)] rounded-2xl p-8">
                  <h3 className="font-heading text-xl font-medium text-[var(--color-text)] mb-4">
                    Our Services
                  </h3>
                  <ul className="space-y-3">
                    {siteConfig.services.slice(0, 5).map(service => (
                      <li key={service.id} className="flex items-center gap-2">
                        ...
                        <span className="text-[var(--color-text-secondary)] text-sm">{service.name}</span>
                      </li>
                    ))}
                  </ul>
                  <Link
                    to="/services"
                    className="inline-flex items-center gap-1 text-[var(--color-primary)] text-sm font-medium mt-4 hover:text-[var(--color-primary-dark)] transition-colors"
                  >
                    View all services
                  </Link>
                </div>
      ...
      <section className="py-16 bg-[var(--color-surface)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <h2 className="font-heading text-3xl font-medium text-[var(--color-text)] mb-8 text-center">
              Booking Information
            </h2>
          </AnimatedSection>
            ...
            {[
              {
                ...
                a: 'Fill out the form with your preferred date, time, and service. We\'ll contact you to confirm your appointment.',
              },
              {
                q: 'Can I book for the same day?',
                a: 'Same-day appointments may be available. Please call us directly to check availability.',
              },
              {
                q: 'Do I need to pay in advance?',
                a: 'Payment is typically collected at the salon after your service. For bridal packages, a deposit may be required.',
              },
              {
                q: 'What if I need to cancel or reschedule?',
                a: 'Please contact us at least 24 hours in advance if you need to cancel or reschedule your appointment.',
              },
            ].map((item, index) => (
